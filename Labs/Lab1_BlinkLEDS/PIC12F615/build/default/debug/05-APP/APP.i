...
void main(void) {
    ...
    *((volatile unit8_t * )0x1A)=0;
    *((volatile unit8_t * )0x1F)=0;
    *((volatile unit8_t * )0x8C)=0;
    *((volatile unit8_t * )0x93)=1;
    *((volatile unit8_t * )0x15)=0;
    *((volatile unit8_t * )0x12)=0;
    *((volatile unit8_t * )0x96)=0;
    *((volatile unit8_t * )0x95)=0;
    ...
    *((volatile unit8_t * )0x93)=1;
        ...
        ((REG_8BIT_t *)0x005)->All_REG=0b00000001;
        DIO_Write(0x01,0xFF);
        _delay((unsigned long)((1000)*(8000000/4000.0)));
       ((REG_8BIT_t *)0x005)->All_REG=0b00000011;
       _delay((unsigned long)((1000)*(8000000/4000.0)));
       ((REG_8BIT_t *)0x005)->All_REG=0b00000111;
        _delay((unsigned long)((2000)*(8000000/4000.0)));
        ((REG_8BIT_t *)0x005)->All_REG=0b00010111;
        _delay((unsigned long)((1000)*(8000000/4000.0)));
        ((REG_8BIT_t *)0x005)->All_REG=0b00110111;
       _delay((unsigned long)((1000)*(8000000/4000.0)));
# 106 "05-APP/APP.c"
    }
...
void DIO_Write(unit8_t pins,unit8_t value)
{
 ...
 unit8_t u8_temp_reg;
 unit8_t u8_masked_pins;

    u8_temp_reg = *((volatile unit8_t * )0x005) &~(pins);
    u8_masked_pins=(pins)&(value);
    *((volatile unit8_t * )0x005)= u8_temp_reg|u8_masked_pins;
